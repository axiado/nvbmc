...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/firmware_eip207_ifpp.bin ${D}${nonarch_base_libdir}/firmware/
    install -m 0644 ${WORKDIR}/firmware_eip207_ipue.bin ${D}${nonarch_base_libdir}/firmware/
    install -m 0644 ${WORKDIR}/firmware_eip207_ofpp.bin ${D}${nonarch_base_libdir}/firmware/
    install -m 0644 ${WORKDIR}/firmware_eip207_opue.bin ${D}${nonarch_base_libdir}/firmware/
}
